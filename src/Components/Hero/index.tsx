      ...
      <section className="px-12 py-10 flex justify-between items-center text-white">
        <div className="max-w-3xl">
          <h1 className="text-4xl font-bold hero-title">
            <span className="text-[rgb(170,142,214)]">A Bot de Discord mais completa </span><span className="text-white">com tudo que seu servidor precisa!</span>
          </h1>
          <div className="hero-description-container mt-4 text-gray-400">
              <p className="hero-description">Olá meu nome é Kora! Sou uma bot focada em comandos de: Moderação, diversão, gerais e um incrível sistema de RPG o <b>Rush Dungeon.</b> Ficou interessado(a) em me conhecer? Me adicione agora e veja o mundo infinito de possibilidade para seu servidor. Tchauu 💜</p>
          </div>
