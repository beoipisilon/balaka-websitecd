...
export function CommandsList({ commands, setSelectedCommand,selectedCategory }) {
    return (
    <>
    
        <div className="rounded-lg m-5 bg-[rgb(41,41,46)] text-white p-4 flex-grow max-w-xl">
