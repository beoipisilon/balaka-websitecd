            ...
            <AnimatePresence>
                {command && (
                    <motion.div
                        ...
                        className="rounded-lg m-5 bg-gradient-to-br from-[rgb(41,41,46)] to-[rgb(31,31,36)] text-white p-4 flex-grow max-w-md"
                        >
                        ...
                        <div className="mb-4">
                            ...
                            <div className="flex">
                                {command.perms.map((i) => (
                                    <span className="mr-2 p-1 text-white border border-purple-500 text-gray-400 text-sm rounded-lg">{i}</span>
                                ))}
                            </div>
                        </div>
                        <div className="mb-4">
